...
function [ydot, LTCC_out] = LTCC_mode_1(state, Caj, Vm, najLCC, kjLCC, ISO_PKA, Frdy, FoRT,  Cao, Nao, Ko, gender_flag, AF, L_type_k1o)
...
if gender_flag == 0
    k1o = L_type_k1o*1.2 * 1.4 * 1.3 * 5.0 * 0.024168 * (1 - 0.67 * AF);
elseif gender_flag == 1
    k1o = L_type_k1o*1.2 * 1.4 * 1.3 * 5.0 * 0.024168;
end
